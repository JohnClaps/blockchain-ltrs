...
import {FaGlobe,FaXTwitter, FaFacebook, FaLinkedin } from 'react-icons/fa6';
         ...
         <div className="footer-content">
           ...
           <div className="footer-section">
             ...
             <div className="social-links">
               ...
               <a href="https://mw.linkedin.com/company/higher-education-students-loans-and-grants-board-heslgb" target='_blank' rel='noopener noreferrer'>
               <FaLinkedin className="hover:text-blue transition-colors duration-200" size={25}/>
               </a>
               <a href="https://www.heslgb.mw" target='_blank' rel='noopener noreferrer'>
               <FaGlobe className='hover:text-blue transition-colors duration-200' size={25}/>
               </a>
               <a href='https://x.com/HESLGB1' target='_blank' rel='noopener noreferrer'>
